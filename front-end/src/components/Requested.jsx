    ...
    const getRequested = async () =>{
      ...
      for(let i=0; i<_reqIndices; i++){
        ...
        if(reqLand[3].words[0] != 0){
          ...
          const landLongitudeLatitude = await contract.getLandLongitudeLatitude(reqLand[0], reqLand[1], reqLand[2], reqLand[3].words[0], {
            from: account
          })
          ...
          const landDetails2 = {state: reqLand[0], district: reqLand[1], city: reqLand[2], surveyNo: reqLand[3].words[0], longitude, latitude}
