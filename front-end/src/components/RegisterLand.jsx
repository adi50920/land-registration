...
const RegisterLand = (props) => {
  ...
  const [landDetails, setLandDetials] = useState({
    state:"", district:"", city:"", propertyId:"", surveyNo:"", owner:"", marketValue:"", size:"", longitude:"", latitude:""
  }) 
  ...
  const handleOnClick = async () =>{
    await contract.registerLand(landDetails.state, landDetails.district, landDetails.city, landDetails.propertyId, landDetails.surveyNo, landDetails.owner, landDetails.marketValue, landDetails.size, landDetails.longitude, landDetails.latitude, {
      from: account
    })
    console.log(landDetails)
    setLandDetials({state:"", district:"", city:"", propertyId:"", surveyNo:"", owner:"", marketValue:"", size:"", longitude:"", latitude:""})
  }
        ...
        <div className='col-12 col-sm-6'>
            <form method='POST' className='admin-form'>
                ...
                <div className='form-group'>
                    ...
                    autoComplete="off" value={landDetails.latitude} onChange={onChangeFunc}/>
                </div>
                <div className='form-group'>
        ...
        <div className='col-12 col-sm-6'>
          <form method='POST' className='admin-form'>
            ...
            <div className='form-group'>
                    ...
                    autoComplete="off" value={landDetails.longitude} onChange={onChangeFunc}/>
            </div>            
            <div className='form-group'>
                <label>Size</label>
