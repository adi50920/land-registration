...
contract Registry{
    ...
    mapping(string => mapping(string => mapping(string => mapping(uint => LandDetails)))) landDetalsMap; // state => district => city => surveyNo => LandDetails
    mapping(string => mapping(string => mapping(string => mapping(uint => LandLongitudeLatitude)))) LandLongitudeLatitudeMap; // state => district => city => surveyNo => LandLongitudeLatitude
    ...
    function registerLand(string memory _state, string memory _district, string memory _city, uint256 _propertyId, uint _surveyNo, address _owner, uint _marketValue, uint _sqft, string memory _longitude, string memory _latitude) external onlyAdmin{
        ...
        LandLongitudeLatitude storage newLandLongitudeLatitude = LandLongitudeLatitudeMap[_state][_district][_city][_surveyNo];
        ...
        newLandLongitudeLatitude.longitude = _longitude;
        newLandLongitudeLatitude.latitude = _latitude;
    ...
    function getLandLongitudeLatitude(string memory _state, string memory _district, string memory _city, uint _surveyNo) public view returns (string memory, string memory){
        string memory longitude = LandLongitudeLatitudeMap[_state][_district][_city][_surveyNo].longitude;
        string memory latitude = LandLongitudeLatitudeMap[_state][_district][_city][_surveyNo].latitude;
