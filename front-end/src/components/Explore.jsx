...
const Explore = (props) => {
  ...
  const [landDetail, setLandDetail] = useState({
    owner:"", propertyId:"", index:"", marketValue:"", sqft:"",  longitude:"", latitude:""
  })
  ...
  const handleOnClick = async () =>{
    ...
    const landLongitudeLatitude = await contract.getLandLongitudeLatitude(explore.state, explore.district, explore.city, explore.surveyNo, {
      from: account
    })
    ...
    setLandDetail({owner, propertyId, index, marketValue, sqft, surveyNo, longitude, latitude})
