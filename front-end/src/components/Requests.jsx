        ...
        if(ownerOwns[3].words[0] != 0){
          ...
          if(noOfRequests > 0){
            ...
            for(let j = 0; j<noOfRequests; j++){
              ...
              const reqDetails = {state: ownerOwns[0], district: ownerOwns[1], city: ownerOwns[2], surveyNo: ownerOwns[3].words[0], index: i, reqNo: j, requester, propertyId, longitude, latitude}
